(ns texmachmfg.phase
  "Phase 0->3 staged rollout for the textile/apparel/leather
  production-machinery (weaving looms, industrial sewing machines,
  leather-cutting machines, knitting machines and fabric-cutting
  machines) plant-operations coordination actor.
  ...
  `texmachmfg.governor`'s `equipment-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map a Textile, Apparel and Leather Machinery Plant Operations
