# Business Model: Manufacture of machinery for textile, apparel and leather production
...
## Classification
- Repository: `cloud-itonami-isic-2826` ([github.com/cloud-itonami/cloud-itonami-isic-2826](https://github.com/cloud-itonami/cloud-itonami-isic-2826))
- ISIC Rev.5: `2826` — Manufacture of machinery for textile, apparel and leather production
- Domain: `:textile-apparel-leather-machinery/manufacturing`
- Social impact: :worker-safety :mechanical-safety :electrical-safety
- Actor: `:textile-apparel-leather-machinery-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :textile-apparel-leather-machinery/manufacturing — who wants
...
One managed tenant (:textile-apparel-leather-machinery/manufacturing):
...
- Do not bypass the `:textile-apparel-leather-machinery-plant-operations-governor` for production decisions.
