# Operator Quickstart — Manufacture of machinery for textile, apparel and leather production

Shortest path from clone to a verified local dry-run for **ISIC 2826** (`cloud-itonami-isic-2826`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2826.git
cd cloud-itonami-isic-2826
```
...
- Blueprint governor key: `textile-apparel-leather-machinery-plant-operations-governor`
- Likely source path: `texmachmfg.governor.cljc`
